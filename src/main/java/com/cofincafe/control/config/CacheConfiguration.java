package com.cofincafe.control.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cofincafe.control.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cofincafe.control.repository.UserRepository.USERS_BY_EMAIL_CACHE);
